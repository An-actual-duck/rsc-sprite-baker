...
class CompatibilityCensusTest {
    @Test void aggregatesStableCategoriesBlockersAndModelClusters() {
        List<NpcCompatibility> definitions = List.of(
            ...
            result(4, NpcCompatibility.Category.UNSUPPORTED_MODEL,
                "model 101: IllegalArgumentException: newPosition > limit: (123 > 45)"),
            result(5, NpcCompatibility.Category.UNSUPPORTED_MODEL,
                "model 102: IllegalArgumentException: newPosition > limit: (678 > 90)"));
        ...
        assertEquals(6, census.definitionCount);
        ...
        assertEquals(2, census.modelFailureClusters.get("IllegalArgumentException: newPosition > limit"));
