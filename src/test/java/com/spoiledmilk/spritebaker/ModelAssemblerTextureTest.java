...
class ModelAssemblerTextureTest {
    @Test void offsetsNeutralComponentVerticesAndTextureMappings(){
        ...
        assertArrayEquals(new short[]{0,3},combined.texIndices1);assertArrayEquals(new short[]{1,4},combined.texIndices2);assertArrayEquals(new short[]{2,5},combined.texIndices3);
