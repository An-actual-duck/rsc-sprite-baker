...
public final class VisualSettings {
    ...
    public String palette = PaletteReducer.RSC_64;
    public String dithering = PaletteReducer.ORDERED_4X4;
    public double ditherStrength = 0.45;
    ...
    public void applyPreset(String name) {
        ...
        switch (name) {
            ...
            case "RSC crisp":
                ...
                palette = PaletteReducer.RSC_64; dithering = PaletteReducer.NO_DITHER; break;
            case "RSC restrained":
                pitchDegrees = 12; modelScale = 0.9; verticalOffsetPixels = 0;
                ambient = 0.52; diffuse = 0.40; lightAzimuthDegrees = -125; lightElevationDegrees = 45;
                palette = PaletteReducer.RSC_64; dithering = PaletteReducer.ORDERED_4X4; ditherStrength = 0.45; break;
            case "RSC coarse":
                ...
                palette = PaletteReducer.RSC_27; dithering = PaletteReducer.ORDERED_4X4; ditherStrength = 0.6; break;
