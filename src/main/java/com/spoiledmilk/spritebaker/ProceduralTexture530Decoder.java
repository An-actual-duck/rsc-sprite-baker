...
public final class ProceduralTexture530Decoder {
    ...
    private static final class Combine extends Node{
        ...
        void finish(int id){if(function!=1&&function!=2&&function!=3&&function!=5&&function!=6&&function!=7&&function!=8&&function!=10&&function!=11)throw new UnsupportedTextureFormatException(id,"combine function "+function);}
        int[] rgb(int x,int y,int size)throws IOException{
